...
timeEvent = "19:00"
dateEvent = "26 декабря"
yearEvent = "2022"
placeEvent = "улица Лиственная дом 18, корпус 3"
carModel = "mazda"
carSign = "к294ва147"
...
message = "{date} {year} года около {time} водитель автомобиля {model} (регистрационный знак" \
     ...
     "данного обращения.".format(time=timeEvent, date=dateEvent, year=yearEvent, model=carModel, sign=carSign,
                                 place=placeEvent)
